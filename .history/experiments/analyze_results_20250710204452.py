...
def generate_full_report(result: BacktestResult, result_name: str):
    ...
    # Sanitize the directory name to avoid issues with spaces and special characters
    safe_dir_name = result_name.replace(" ", "_").replace("/", "_").replace("\\", "_")
    report_path = figures_path() / safe_dir_name
...
if __name__ == "__main__":
    ...
    result_name = "Dynamic Uniform Strategy" # A nice name for titles and labels
