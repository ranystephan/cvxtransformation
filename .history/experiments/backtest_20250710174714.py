...
def run_backtest(
    ...
    # MODFICATION 5.1: For Monte-Carlo analysis (starting at different dates)
    if start_time is not None: 
        # Find the integer index corresponding to the provided start_time
        start_idx = prices.index.get_loc(start_time)

    training_length = 1250

    # We must ensure the start index is after the initial training/warm-up period
    if start_idx < training_length: 
